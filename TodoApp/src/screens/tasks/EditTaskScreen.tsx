...
const EditTaskScreen: React.FC = () => {
  ...
  const validateForm = (): boolean => {
    ...
    // Date validation
    const now = new Date();
    if (status !== TaskStatus.COMPLETED && dueDate < now) {
      setDateError('Due date cannot be in the past for active tasks');
      isValid = false;
    }
  ...
  if (isLoading) {
    return <LoadingSpinner text="Updating task..." />;
  }
